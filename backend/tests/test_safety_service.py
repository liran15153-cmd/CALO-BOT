...
def test_safety_service_keeps_red_flag_symptoms_hard_blocked(tmp_path):
    ...
    for message in [
        ...
        "I have dizziness during workouts",
        "I passed out at the gym",
        "shortness of breath while lifting",
        "I get short of breath while lifting",
        "palpitations while lifting",
        "יש לי כאב בחזה בזמן אימון",
        "כואב לי החזה בזמן אימון",
        "יש לי כאבים בחזה אחרי ריצה",
        "יש לי דקירה בחזה כשאני מרים",
